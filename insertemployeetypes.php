	...
	<div class="card-body">
		...
		if (isset($_POST['insert'])) {
			...
			if (empty($formfield['name']) || empty($formfield['description'])) {
				...
				// Attempt to insert
				try {
					$sqlnewtype = "INSERT into employeetype(employeetypename, employeetypedescription, employeetypepermission)
					VALUES (:bvname, :bvdescription, :bvpermission)";
